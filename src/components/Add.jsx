  ...
  return (
    <div>
        ...
        <StyledModal
            ...
            >
            <Box width={400} height={280} color={"text.primary"} bgcolor={"background.default"} p={3} borderRadius={5}>
                <Typography variant="h6" color={"gray"} textAlign={"center"}>Create post</Typography>
                <UserBox>
                    <Avatar
                        src="src=https://images.unsplash.com/photo-1551782450-a2132b4ba21d"
